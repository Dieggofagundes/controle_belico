    ...
    <div className="field">
      ...
      {!confirmed && (
        <div style={{ display: "flex", gap: 8, marginBottom: 6 }}>
          <button
            type="button"
            className={modo === "desenho" ? "btn btn-primary" : "btn btn-ghost"}
            onClick={() => alternarModo("desenho")}
          >
            Desenhar
          </button>
          <button
            type="button"
            className={modo === "imagem" ? "btn btn-primary" : "btn btn-ghost"}
            onClick={() => alternarModo("imagem")}
          >
